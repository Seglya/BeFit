...
{/*[Authorize]*/
    public class MeasurementController : Controller
    {
        ...
        public MeasurementController(IFillMeasurementRepository fillMeasurementRepository, IMeasurementRepository measurementRepository, IAppUserRepository appUserRepository)
        {
        ...
        {List<AddMeasurementViewModel> list=new List<AddMeasurementViewModel>();
        ...
        {
            List<DetailMeasureVeiwModel> list=new List<DetailMeasureVeiwModel>();
            ...
            {var detail=new DetailMeasureVeiwModel();
                DateTime date = measurement.Date.Date;
               if (date != prevDate)
                {
                    detail.Date = date;
